			...
			<?php
				if(isset($_SESSION['IS_AUTHENTICATED']) && $_SESSION['IS_AUTHENTICATED'] == 1)
				{
					...
					$complaint=$_POST['complaint'];
						...
						$q="INSERT INTO complaint(COMPLAINT_ID,MEMBER_ID,COMPLAINT) VALUES ($count,'$member_id','$complaint')";
						$x=mysqli_query($link,$q);
						
						if(!$x)
						{
							echo "<h2>SOMETHING WENT WRONG... TRY AGAIN LATER</br></h2>";
							echo "<a href='complaint_box.php' class='back'>GO BACK</a>";						
						}
						
						else
						{
							echo "<h2>YOU HAVE SUCCESSFULLY REGISTERED YOUR COMPLAINT</h2></br>";
							echo "<a href='complaint_box.php' class='back'>GO BACK</a>";						
						}
