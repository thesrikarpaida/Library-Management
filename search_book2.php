	...
	<body>
		...
		<div class="bg-text">
			...
			<?php
					...
					if(!$r)
					{
						echo "<h2 style='color:black'>BOOK IS NOT AVAILABLE IN LIBRARY</h2>";
						echo "<a href='search_book1.php'>GO BACK</a>";												
					}
					...
					else
					{
						...
						while ($r)
						{
							...
							$q1="SELECT *
							FROM books
							WHERE BOOK_ID NOT IN (SELECT BOOK_ID FROM issue_status)&& BOOK_ID='$bb'";
					...
					$r=mysqli_fetch_array($x);
						...
						echo "</table></center><h3 style='color:red'>Red indicates book is issued by someone</h3>";
						echo "<a href='search_book1.php'>GO BACK</a>";
					}
				}
