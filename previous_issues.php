	...
	<body>
		...
		<div class="bg-text">
			...
			<?php
					...
					$q="SELECT distinct BOOK_NAME,AUTHOR
						FROM books,return_status
						WHERE books.BOOK_ID=return_status.BOOK_ID AND MEMBER_ID='$member_id'";
					...
					if(!$row)
					{
						echo "<h2 style='color:black'>NO PREVIOUS ISSUES</h2>";
						echo "<a href='member_main_page.php'>GO BACK</a>";										
					}
