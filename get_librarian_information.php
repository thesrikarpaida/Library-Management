	...
	<body>
		...
		<?php
			if(isset($_SESSION['IS_AUTHENTICATED']) && $_SESSION['IS_AUTHENTICATED'] == 1)
			{
				...
				$q="SELECT LIBRARIAN_ID,LIBRARIAN_NAME,MOBILE_NO,MAIL_ID
					FROM librarian
				...
				$t=mysqli_fetch_array($r);
						...
						echo "<center><table border=0; cellpadding=15>
						<tr>
						<td style='text-align:right'>LIBRARIAN ID:</td>
						<td>".$t['LIBRARIAN_ID']."</td>
						</tr>
				
						<tr>
						<td style='text-align:right'>NAME:</td>
						<td>".$t['LIBRARIAN_NAME']."</td>
						</tr>
		...
		<center><a href='update_librarian_information.php' class="upd">UPDATE</a></center>
	</body>
</html>