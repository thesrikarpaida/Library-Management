		...
		<div class="bg-text">
			...
			<?php
				if(isset($_SESSION['IS_AUTHENTICATED']) && $_SESSION['IS_AUTHENTICATED'] == 1)
				{
					...
					$q="SELECT *
						FROM complaint
						WHERE COMPLAINT_ID=$complaint_id AND REPLY IS NULL";
					...
					if(!$r)
					{
						...
						echo "<a href='reply_box.php' class='back'>GO BACK</a>";						
					}
					...
					else
					{
						...
						if(!$x)
						{
							echo "<h2>SOMETHING WENT WRONG... TRY AGAIN LATER</h2><br>";
							echo "<a href='reply_box.php' class='back'>GO BACK</a>";						
						}
						...
						else
						{
							...
							if(!$x)
							{
								echo "<h2>REPLY IS NOT GIVEN...TRY IT AGAIN</h2><br>";
							echo "<a href='reply_box.php' class='back'>GO BACK</a>";						
							}
							
							else
							{
								echo "<h2>YOU HAVE SUCCESSFULLY SENT YOUR REPLY</h2><br>";
								echo "<a href='reply_box.php' class='back'>GO BACK</a>";						
							}
						}
					}
